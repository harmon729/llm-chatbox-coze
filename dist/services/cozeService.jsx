...
export async function quickChat(message) {
    try {
        ...
        if (v.chat.status === ChatStatus.COMPLETED && v.messages) {
            // 找到助手的回复
            const assistantMessage = v.messages.find((msg) => msg.role === RoleType.Assistant);
            return {
                content: (assistantMessage === null || assistantMessage === void 0 ? void 0 : assistantMessage.content) || "没有收到回复",
                success: true,
            };
        }
        return {
 ...
 */
export async function streamChat(message, onPartialResponse, onComplete, onError) {
    var _a, e_1, _b, _c;
    try {
...
//# sourceMappingURL=cozeService.jsx.map